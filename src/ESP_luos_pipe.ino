...
void wifi_setup()
{
    ...
    if ((Router_SSID != "") && (Router_Pass != ""))
    {
        ...
        ESPAsync_wifiManager.setConfigPortalTimeout(2); // If no access point name has been previously entered disable timeout.
        Serial.println(F("Got ESP Self-Stored Credentials. Timeout 2s for Config Portal"));
    }
    ...
    if (loadConfigData())
    {
        ...
        ESPAsync_wifiManager.setConfigPortalTimeout(2); // If no access point name has been previously entered disable timeout.
        Serial.println(F("Got stored Credentials. Timeout 2s for Config Portal"));
